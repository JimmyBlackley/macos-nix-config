# Generated by Powerlevel10k configuration wizard on 2025-12-13 at 18:08 AEDT.
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    # context               # user@hostname (disabled - just show directory)
  ...
  # Hide context completely - always empty
  typeset -g DEFAULT_USER='james'
